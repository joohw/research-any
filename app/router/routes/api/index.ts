// API 路由汇总：server、rss、items、feed、sources、channels、enrich、scheduler、plugins、logs、events、admin、tags、agent-tasks、daily-reports
...
import { registerDailyReportsRoutes } from "./daily-reports.js";
